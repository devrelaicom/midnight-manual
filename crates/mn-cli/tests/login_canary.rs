...
//!
//! 2. Any [`mn_telemetry::canary`] string fed in as a request input.
//!
...
use mn_auth::Keypair;
use mn_telemetry::canary::{find_first_match, CANARY_PREFIX};
use serde_json::json;
...
async fn login_output_does_not_carry_token() {
    ...
    let rendered = mn_cli::commands::login::format_success(
        "aaron",

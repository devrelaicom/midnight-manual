//! Shared test fixtures for mn-server integration tests.
//!
//! These helpers mirror those in `crates/mn-store/tests/fixtures.rs` so that
//! mn-server integration tests can set up a standard corpus without depending

...
//! [`mnm_telemetry::HttpClient`] into the live `/v1/telemetry/events` route,
...
//!
//! - The typed [`mnm_telemetry::Event`] payload has no free-form string field
...
use mnm_telemetry::canary::{self, find_first_match, CANARY_STRINGS};
...
async fn end_to_end_canary_pipeline_leaves_no_canary_strings() {
    ...
    mnm_telemetry::optout::set_runtime_disabled(false);

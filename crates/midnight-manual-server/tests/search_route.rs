...
//! Real-embedding tests land alongside mnm-embedding in a later phase.
...
use mnm_core::provenance::{Attribution, ContentType, LanguageTarget, Provenance, SdkDependency};

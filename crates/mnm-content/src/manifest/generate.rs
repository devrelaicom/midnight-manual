...
# Schema: crates/mnm-content/src/manifest/mod.rs (manifest_version = 1).
#
...
mod tests {
    ...
    fn emit_yaml_starts_with_header_comment() {
        ...
        // Default-true `code_embeddings` is skipped so generated manifests stay clean.
        assert!(!body.contains("code_embeddings"));
    }

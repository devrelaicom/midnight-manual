...
| FR-047 | Compact (.compact) chunking MUST identify top-level 'module <Name> { ... }' blocks at MVP without a full tree-sitter grammar; chunks MUST be tagged with the enclosing module name; inside-module chunking MAY use line-window until a grammar is available. | 3 | 🔵 Confirmed |

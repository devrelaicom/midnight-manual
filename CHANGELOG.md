...
- *(mcp)* answer CORS preflights on the HTTP transport ([#209](https://github.com/devrelaicom/midnight-manual/pull/209))

## [0.12.1](https://github.com/devrelaicom/midnight-manual/compare/v0.12.0...v0.12.1) - 2026-07-25

### Added

- *(mcp)* add Streamable HTTP transport alongside stdio ([#204](https://github.com/devrelaicom/midnight-manual/pull/204))

## [0.12.0](https://github.com/devrelaicom/midnight-manual/compare/v0.11.0...v0.12.0) - 2026-07-08

### Added

- *(observability)* Sentry four-pillar expansion (traces + logs + metrics) with two-sinks privacy model ([#202](https://github.com/devrelaicom/midnight-manual/pull/202))
